import {AbstractData, DataMap, IDatabaseClassItem, IDatabaseItem, IDatabaseItemRaw, IDatabaseListItem, IDatabaseNextKeyItem, IDatabaseRow, IDictionary, INumberDictionary, IStringDictionary} from '../../lib/index.ts'
import Log from '../../lib/SharedUtils/Log.ts'
import ValueUtils from '../../lib/SharedUtils/ValueUtils.ts'
import DatabaseSingleton, {TDatabaseQueryInput} from '../Singletons/DatabaseSingleton.ts'
