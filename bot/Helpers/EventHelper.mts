import {AbstractTrigger, DataUtils, EventDefault, IDictionary, TriggerReward} from '../../lib/index.mts'
...
export default class EventHelper {
    static async getAllTriggersOfType<T>(triggerInstance: T&AbstractTrigger): Promise<(T&AbstractTrigger)[]> {
        const allEvents = DataUtils.getKeyDataDictionary<EventDefault>(DatabaseHelper.loadAll<EventDefault>(new EventDefault()) ?? {})
