...
* __DONE__: We finally have a live websocket connection between the BotController and the Vue Presenter.
  * __TODO__: Figure out the format of the messages we want to send to the Presenter, there is a types class for this already: `./lib/Types/WebSocket/Presenter.ts`
