...
import {IDictionary} from '../../../Types/Dictionary.ts'
import {OptionEventRun} from '../../Options/OptionEventRun.ts'
import {AbstractAction} from '../Action/AbstractAction.ts'
import {AbstractEvent} from './AbstractEvent.ts'

export class EventTest extends AbstractEvent {
    ...
    enlist() {
        ItemMap.addRootInstance({
            ...
            types: {
                ...
                triggers: AbstractItem.genericRef('Trigger').build(),
...
export class EventOptions extends AbstractItem {
...
export class EventActionContainer extends AbstractItem {
...
export class EventRewardOptions extends AbstractItem {
...
export class EventIncrementingOptions extends AbstractItem {
    loop: boolean = false
    maxValue: number = 0
...
export class EventAccumulatingOptions extends AbstractItem {
    goal: number = 0
...
export class EventMultiTierOptions extends AbstractItem {
    timeout: number = 30
    maxLevel: number = 0
